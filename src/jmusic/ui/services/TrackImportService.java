...
public class TrackImportService extends Service< Void > {
    private final Library mLibrary;
    private final Map< Long, LibraryItem > mTracks;
    private final Long mTargetRootId;

    public TrackImportService( Library inLibrary, Map< Long, LibraryItem > inTracks, Long inTargetRootId ) {
        mLibrary = inLibrary;
        mTracks = inTracks;
